...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/deyang143@126.com/ZKIDCardCamera'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'deyang143@126.com' => 'deyang143@126.com' }
  s.source           = { :git => 'https://github.com/deyang143@126.com/ZKIDCardCamera.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'ZKIDCardCamera' => ['ZKIDCardCamera/Assets/*.png']
  # }
